    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(blank=True, max_length=254, unique=True, verbose_name='Юзернейм пользователя')),
                ('first_name', models.CharField(max_length=254, verbose_name='Имя пользователя')),
                ('last_name', models.CharField(max_length=254, verbose_name='Фамилия пользователя')),
